...
export default function CreateUser() {
    ...
    const handleSubmit = async e => {
        ...
        if (password != confirmPassword) {
            ...
            console.log(data);
            let response = await create('/user/store', { data });
            console.log(response);
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-6">
                                        <input id="name" type="text" className="form-control " name="name" onChange={e => {
                                ...
                                <div className="form-group row">
                                    <label htmlFor="email" className="col-md-4 col-form-label text-md-right">Role</label>
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-6">
                                        <input id="password" type="password" className="form-control" onChange={e => {
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-md-6">
                                        <input id="password-confirm" onChange={e => {
                                            setConfirmPassword(e.target.value);

                                        }} type="password" className="form-control" name="password_confirmation" required autoComplete="new-password" />
                                    </div>
                                </div>
